   ...
   $qb = "SELECT * FROM usuarios where correo_cifrado = '$clave' ";// preparando la instruccion sql
    $resultb= $dbhb->query($qb);
    	...
    	if ($resultb->num_rows > 0) {
			 ...
			 $user_name = $row['usuario']; 
			 $foto = $row['foto'];
			 $datos_encontrados= $error.'|'.$nombre.'|'.$correo.'|'.$user_name.'|'.$foto.'|'.$row['id'].'|'.$row['clave'].'|'.$row['fecha_registro'].'|'.$row['fecha_activado'].'|'.$row['fecha_banned'].'|'.$row['estado'].'|'.$row['password'];
	    }else{
		    $error = 1 ;
		    $nombre = '';
			$correo= '';
	...
	//var_dump($solo_dir);
				   			...
				   			for($i=0; $i<= count($data_opt); $i++){
						   		...
						   		if ($num%2==0){
									...
									$btn_edita = '<button onclick="toggle_ops(1);edita_img(\''.$nombre.'.'.$ext.'\')" class="btn btn-inverse-primary btn_thin" > <i class="fa fa-pencil" ></i> </button>';
...
$ant = '';
	...
	$qb = "SELECT * FROM recibos where id_user = $id_user and estado_recibo < 99 order by nombre_prod, id asc ";// preparando la instruccion sql
					...
					$reciboss .= '<hr>';
						...
						$recibos .='
							<tr>
								...
								<td> <a class="text-primary" href="'.$venatana_detalle.'" style="font-size:0.8rem;"> Ver Detalles </a> </td>
							</tr>
						'; 
		...
		<table class="table table-striped">
						<thead>
							<tr>
								...
								<th class="thead_content"> Detalles </th>
							</tr>
						</thead> 
						<tbody>'.$recibos.'
						</tbody>
...
//var_dump($qb);
	...
	$panels = '
				<div class="row">
					<div class="col-md-4" style=" height: 350px; padding:0px;" >
					
						<div class="col-md-12 " style="padding:0px; height: 467px; ">
								
							
								<div class="col-md-12 p-2  subtitle_sec">
									<i class="fa fa-list-ul"></i> Movimientos
								</div>
	
						
								<div style="height: 430px; overflow:scroll; scroll-y:auto; scroll-x:none;">
					...
					<div class="col-md-4" style=" height: 370px; border-left: 1px solid #ccc;" >
						
						<div class="p-1 col-md-12  ">
							<div class="col-sm-12 text-primary">
								<i class="fa fa-donate"></i> Balance Mensual
							</div>
						</div>							
						...
						<div class="col-md-12 row ">
							...
							<div class="col-md-6 border-right">
								<label class="col-md-12 text-muted text-small label_thin"> Del: </label>
								<label class="col-md-12 text-small label_thin"> '.formatFecha($inicio_mes).' </label>
							</div>	

							<div class="col-md-6 ">
								<label class="col-md-12 text-muted text-small label_thin"> Fecha:</label>
						...
						<div class="col-md-12 row ">	
							...
							<div class="col-md-6">
								<label class="col-md-12 text-muted text-small label_thin"> Ingreso :</label>
								<label class="col-md-12 text-small label_thin"> <span class="text-success">'.money_format('%(#10n',$ingreso).'</span>   </label>
							</div>
							
							<div class="col-md-6 ">
								<label class="col-md-12 text-muted text-small label_thin"> Devuelto:</label>
								<label class="col-md-12 text-small label_thin"> <span class="text-danger">'.money_format('%(#10n',$ingreso_desc).'</span>  </label>
							</div>								
						...
						<div class="col-md-12 row">
							<div class="row col-md-12 label_thin">
								<label class="col-sm-9 text-primary text-small label_thin"> Movimientos:</label>
								<label class="col-sm-2 text-small label_thin">'.$total_mov.'</label>
							</div>	

							<div class="row col-md-12 border-top ">
								<label class="col-sm-9 text-muted text-small label_thin"> Aprobados:</label>
								<label class="col-sm-2 text-small label_thin">'.$aprovados.'</label>
							</div>																
									
							<div class="row col-md-12 border-top ">
								<label class="col-sm-9 text-muted text-small label_thin"> Cancelados:</label>
								<label class="col-sm-2 text-small label_thin">'.$cancel.'</label>
							</div>	
					...
					<div class="col-md-4" style=" height: 370px; overflow: scroll; overflow-x: hidden; overflow-y:auto; border-left: 1px solid #ccc;" >
						
						<div class="p-1 col-md-12  ">
							<div class="col-sm-12 text-primary">
								<i class="fa fa-chart-pie"></i> Balance Acumulado
							</div>
						</div>							
						...
						<div class="col-md-12 row ">	
							...
							<div class="col-md-6 ">
								...
								<label class="col-md-12 text-small label_thin"> <span class="text-success">'. money_format('%(#10n',$ingreso_acum).'</span> </label>
							</div>
							
							<div class="col-md-6 ">
								<label class="col-md-12 text-muted text-small label_thin"> Dev :</label>
								<label class="col-md-12 text-small label_thin"> <span class="text-danger">'.money_format('%(#10n',$ingreso_desc_acum).'</span> </label>
							</div>								
						...
						<div class="col-md-12 row ">
							...
							<div class="row col-md-12 ">
								<label class="col-sm-9 text-primary text-small label_thin"> Movimientos:</label>
								<label class="col-sm-2 text-small label_thin">'.$total_mov_acum.'</label>
							</div>	

							<div class="row col-md-12 border-top ">
								<label class="col-sm-9 text-muted text-small label_thin"> Aprobados:</label>
								<label class="col-sm-2 text-small label_thin">'.$aprovados_acum.'</label>
							</div>																
									
							<div class="row col-md-12 border-top ">
								<label class="col-sm-9 text-muted text-small label_thin"> Cancelados:</label>
								<label class="col-sm-2 text-small label_thin">'.$cancel_acum.'</label>
							</div>	
    	...
    	if ($resultb->num_rows > 0) {
			...
			while($row= $resultb->fetch_assoc()){
				...
				if($current != $ant){
					...
					$ico_estado = '<span class="text-'.$color_sug.'" style="margin-top:15px;"> <i class="fa '.$ico.' fa-2x"></i></span>'; 
...
/////
						...
						$recibos .= '					
							...
							<div id="sug_'.$row['id'].'" class="col-md-12 row hold_serie" style="  ">
								...
								<div class="hold_info" style="width:80%;">
									<h3 style="font-size: 16px; " class="text-muted "> '.$info.' <br> <span class="text-sm"> Folio: '.$row['folio'].'</span> <br>
									<span class="grid-margin-md"><b> '.$row['tipo'].' Serie '.$row['cve_lego'].'</b></span>
										
											
											<div class="col-md-12 bg-light no-show" style="margin: 5px 0px; height:50px; border:1px solid #d3d3d3; overflow:scroll; overflow-x:hidden; overflow-y:hidden;"> 
											...
											<br>
											<span style="font-size:10px; ">Enviado: '.$fecha.'</span>
		    	...
		    	<td class="border-bottomm" style="height:15px; padding-left:3px; "> 
			    	<div class=" form-check-flat  " style="padding-bottom:3px; padding-top:3px; margin-bottom: 0px; margin-top: 0px; " >
		                ...
		                <input type="checkbox" id="'.$row['id'].'" data-titulo="'.$row['title'].'"  data-padre="'.$row['mnu_padre'].'"  '.$chk.' onchange="code_permisos(\''.$row['id'].'\');" class="form-check-input" > 
		                	...
		                	<span class="text-muted" style="font-size:0.7rem; width: 3%; padding:1px 2px; background:rgba(163,183,196, 0.4); margin-right:2px;" >'.$row['id'].'</span> 
                            <span class="text-muted" style="font-size:0.8rem;" > '.$ico_mnu.' '.$row['title'].' </span>
		                	  <i class="input-helper"></i>
		                </label>
			    	</div>
		    	...
		    	<tr class="col-sm-12" style="height: 20px; " >
			    	...
			    	<td style="border:0px solid #ccc; height:20px; padding-left:3px;">
				    	...
				    	<div class=" form-check-flat " style=" padding-bottom:5px; padding-top:5px; margin-bottom: 0px; margin-top: 0px;" >
			                ...
			                <span class="text-muted" style="font-size:0.7rem; width: 3%; padding:1px 2px; background:rgba(163,183,196, 0.4); margin-right:2px;" >'.$rowh['id'].' </span> 
		...
		$result= $dbh->query($q);
			...
			if ($result->num_rows > 0) { // Si la consulta trae registro, cambia el estado
				...
				while($row= $result->fetch_assoc()){
					...
					if($permiso_elimina==1){
						$btn_eliminar='<a  class="btn btn-outline-secondary text-neutral" onclick="elimina_menu(\''.$row['id'].'\')"><i class="fa fa-trash"></i></a>'; 								 
					}else{
					    $btn_eliminar='<a  class="btn btn-secondary text-muted" ><i class="fa fa-trash"></i> </a> '; 
					}
					...
					$menu .= '<div class="blockquote rounded" style="padding: 0px;  margin-bottom: 5px; ">
								...
								<div class="col-md-12" style="padding:0px; display:none;" id="icons_'.$row['id'].'" >
									...
									<div class="" style="padding:0px; display:none; " id="d_'.$row['id'].'" >
										...
										<div class="border-top bg-light " style="margin: 10px 0 0 0; text-align:center; padding: 10px 0px;">
											<a  class="btn btn-outline-secondary text-neutral" onclick="save_menu(\''.$row['id'].'\')" ><i class="fa fa-save"></i></a>
											'.$btn_eliminar.'
											'.$btn_estado.'
										</div>										
									</div>
				...
				while($row= $result->fetch_assoc()){
					...
					$menu .= '<div class="blockquote rounded" style="padding: 0px;  margin-bottom: 5px; ">
                                ...
                                <div class="'.$bg.' '.$text.' text-primary " style="padding: 5px 0 5px 10px; margin-bottom:0px; " >
									...
									<h6 class="'.$text.' mnu_bar" style="margin-bottom: 0; font-size: 12px;">
									<span style="margin-right: 3px; "><i class="fa fa-'.$row['icon'].'"></i></span> 
									'.$row['title'].''.$dots.'
					...
					//echo $GLOBALS['user_perfil'];
						...
						if($permisop ==1){
							...
							$menu .= '<a href="'.$url.'" class="menu_lateral border-bottom '.$text_op.'" style="padding-left:0px; padding-right:0px; padding-top:0px; padding-bottom:0px; margin-left:0px; margin-right:0px; margin-top:0px; margin-bottom:0px; border-bottom:1px solid #ccc; color:'.$GLOBALS['color_txt'].'; " id="mnu_'.$row['id'].'">
										...
										<div class="row col-md-12  '.$bg_op.' '.$border.'" style="background: '.$color_bg.' border-left:3px solid rgba('.$color_code.',1); font-size:0.8em; margin:0px 0px; margin-left:0px; padding:14px 0px 14px 10px; padding-right:0px; border-bottom:1px solid rgba(200,200,200,0.6); " title="'.$row['title'].'">
										    <span class="col-1 "  style=" font-size:1.1em; "><i class="fa fa-'.$row['icon'].'"></i></span> 
											<span class="col-9 " style="font-size:1.1em;"> '.$title.'</span>
											<span class=" '.$col.' text-head"  style="float:right; right:-15px; font-size:1em; "><i class="fa-solid fa-chevron-right"></i></span> 
										</div> 
									</a> '; 
...
function generateRandomString($length = 24) {
    $characters = '0123456789abcdefghijklmnopqrtuvwxyzABCDEFGHIJKLMNOPQRTUVWXYZ';
...
'.$pie.'
		...
		case 3: 
						...
						$linkw = $link_site.'?set=4&parameter='.$parameter;
		...
		case 4: // Notificacion de Bienvenida al usuario
						...
						$enlacew= $path_site.$GLOBALS['login_page'].'?token='.md5($email_user);
				
						$subject_custom = 'Bienvenido '.strtoupper($user_to).' a '.$name_site; 
						...
						$message_custom = '
							...
							<p style="font-weight:normal;padding:0;font-family:&quot;Helvetica Neue&quot;, &quot;Helvetica&quot;, Helvetica, Arial, sans-serif;line-height:1.7;margin-bottom:1.3em;font-size:15px;color:#47505E;font-size:16px;margin-bottom:0; ">
										 ...
										 <br><br>
										 <p style="text-align:center;">
										 <a style="background-color:#00856f;border:1px solid #00856f;border-radius:5px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:50px;text-align:center;text-decoration:none;padding:0 20px;" href="'.$path_site.'resetpass.php" style="text-align: center;" href="'.$enlacew.'"> Activa tu cuenta </a>
										 <br><br>
										 ò
										 <br><br>
			...
			while($row= $resultb->fetch_assoc()){
				...
				if($ultimo != $actual ){
					...
					if($num == 1){
					 ...
					 $title = '<span class="col-sm-12 text-primary" style="font-size:14px;">'.$num.'. '.strtoupper($nom).'</span>';
				...
				<div class="row" style="margin-left:20px; border-top: 0px dashed rgba(150,150,150,0.4);" >
					...
					<a class="col-sm-1 text-gris"  style="font-size:1em; " value="'.$row['id'].'" href="#" onclick="elimina_conf('.$row['id'].')" > 
...
*/
                        ...
                        if($flag_disp_foto == 1){
							...
							<tr>
                                ...
                                <td class="text-muted" style="font-size:0.7em;"> 
									<button class="btn btn-outline-primary btn_thin" style="padding:2px 5px;" type="button"  onclick="display_img(this.value)"  value="'.$datos[$i].'" ><i class=" fa fa-eye"></i> 	 </button> 
...
include("access.php");
	...
	$qb = "SELECT * FROM series where premium = 1 and estado between 1 and 98 order by fecha_lanzamiento";// preparando la instruccion sql
		...
		$forms = '
					...
					<table id="premium" class="table table-striped table-bordered" style="background: #fff;">
                      <thead >
                        <tr>
...
///////////////////////
	...
	//	$forms = $forms.'<input type="hidden" id="current_series_op_conf_'.$user.'" value="'.$series_op.'" >';
		...
		$forms = '
					...
					<table id="opcionales" class="table table-striped" style="background: #fff;">
                      <thead >
                        <tr>
    ...
    $resultb= $dbhb->query($qb);
    	...
    	if ($resultb->num_rows > 0) {
	    	 $row= $resultb->fetch_assoc();
	    	 	...
	    	 	$lbl = '<span id="c_edo_'.$row['id'].'" class="badge  text-'.$row['color'].'" title="'.$row['nombre'].'" style="font-size:12px;"> 
	    	 	<i class="'.$row['icono'].'" style="width: 30px; display:inline-block;" ></i> '.$row['nombre'].' 
	    	 	</span>';         
			    ...
			    if ($result->num_rows > 0) {
	               ...
	               // $data_time = explode(' ',$row['hora_venta']);
	                ...
	                //$hora_b = $data_time[1];
	                        ...
	                        $filas .= '
	                        	...
	                        	<tr>
	                        		...
	                        		<td >
	                        			<span class="text-muted"><span><i class="fa fa-receipt"> </i></span> <span class="text-muted text-small">'.$row['id_recibo'].'</span>
	                        		...
	                        		<td>
	                        			<span class="text-muted text-small">'.$nombre_serie.' - '.$row['nombre_prod'].'</span>
	                        		</td>           
	                ...
	                $campo_buscar = crea_campo_buscar('admin_recibos'); 
    		   	  	...
    		   	  	$tables = '
    		   	  	<h5 class="col-md-12  p-3 title_sec" > Recibos de <b> '.$user_nameb.'</b> </h5>
    		   	  	<div class="card-body" style="padding:5px; margin-right:15px;">
    		   	  	<cardr class="card_recibos grid-margin" style="" searchable="-card_'.$id_usuario.'-" id="card_'.$id_usuario.'">
...
//Select * from recibos, 
              ...
              $qr = "Select * from sugerencias where id_user = $id_usuario order by estado, fecha_envio asc;";// preparando la instruccion sql
			    ...
			    if ($result->num_rows > 0) {
					...
					*///var_dump($user_info);
					...
					if($row['archivado']==1){
						...
						$btn_archivar='
						<button class="btn btn-outline-secondary btn_thin" title="Desarchivar" onclick="edit_sug(\'1-'.$row['id'].'-1\')" > 
						...
						$btn_archivar='
						<button class="btn btn-outline-secondary btn_thin" title="Archivar" onclick="edit_sug(\'1-'.$row['id'].'-1\')" > 
	                       ...
	                       $bg_archivado = ''; 
								...
								// var_dump($perfil);
								 ...
								 if($permiso_elimina==1){
                    					if($row['estado']==99){
                    	                	$btn_eliminar='
                    	                <button class="btn btn-secondary btn_thin text-muted" disabled title="Eliminar" onclick="edit_sug(\'2-'.$row['id'].'\')" > 
                    	                       <i class="fas fa-trash"></i> </button> '; 						
                    					}else{
                    	                	$btn_eliminar='
                    	                <button class="btn btn-outline-secondary btn_thin" title="Eliminar" onclick="edit_sug(\'2-'.$row['id'].'\')" > 
                    	                       <i class="fas fa-trash"></i> </button> '; 						
                    					}
					...
					$btn_guardar = '
						<button class="btn btn-outline-secondary btn_thin" title="Guardar" onclick="edit_sug(\'3-'.$row['id'].'\')" > 
	                       <i class="fas fa-save"></i> </button> '; 
					
					                      	                       
	                $btn_edita='
	                <button class="btn btn-outline-secondary btn_thin" title="Editar" onclick="toggleb(\'row_'.$row['id'].'\')" > 
	                ...
	                $options = '
	                <div class="btn-group" role="group" aria-label="">'.$btn_archivar.$btn_guardar.'</div>&nbsp;&nbsp;&nbsp;<div class="btn-group" role="group" aria-label="">'.$btn_eliminar.'</div>'; 
...
///////	                        
    		   	  ...
    		   	  <h5 class="col-md-12  p-3 title_sec" > Sugerencias de <b> '.$user_nameb.'</b> </h5>
    		   	  	<div class="card-body" style="padding:5px; margin-right:15px;">

    		   	  	
    		   	  	<cardr class="card_recibos grid-margin" searchable="-card_'.$rowr['id_user'].'-" id="card_'.$rowr['id_user'].'">
   ...
   $qb = "SELECT * FROM sugerencias where id = $id_sugerencia; ";// preparando la instruccion sql
    $resultb= $dbhb->query($qb);
    	...
    	if ($resultb->num_rows > 0) {
			 ...
			 $error = 0 ;
			 $datos_encontrados= $error.'|'.$row['id_user'].'|'.$row['fecha_envio'].'|'.$row['cve_lego'].'|'.$row['id_tema'].'|'.$row['tipo'].'|'.$row['detalles'].'|'.$row['estado'].'|'.$row['fecha_completa'].'|'.$row['fecha_respuesta'].'|'.$row['folio'].'|'.$row['archivado'];
	...
	$campo= '
						<div class=" form-group">
						  <div class="input-group">
						   ...
						   <input type="text" class="col-sm-'.$tamanio.' form-control" id="campo_buscar" value="" placeholder="Buscar Registro" onkeyup="search_table(\''.$id_tabla.'\')" >
						  </div>
						  </div>
	';
			...
			$total_fig = busca_info_coleccion($item);
				...
				if($ant != $current){
					...
					if($username!= ''){
                        ...
                        $usuarios .= '
							<div id="user_'.$row['id_user'].'" style="padding-top:0px;" class="col-sm-12 row side_menu '.$class_tarjeta.'" >
								
                                <div class="col-md-2 foto_perfil no-show">
									<img class="img-sm rounded-circle" src="assets/images/faces/profile/'.$foto.'" alt="profile image">
								</div>

								<div class="col-md-8 hold_info_sm">
									<span class="text-muted" style="font-size:1rem" > @'.$username.'</span>
									<span class="ico_disp no-show"> <i class="fa fa-circle" ></i></span> <span class="text-muted">'.$total_fig .' '.$txt_label.'</span><br>
                ...
                <div  class="col-md-12" id="lbl_" style="margin-top:20px;" >
                    <div class="row barcode_holder" style="border:0px solid #ccc; " >
                        ...
                        <div style="display: flex; float:left; width:58%; position:relative; margin-top:2px; text-align:left;">
                            <span style="font-size: 1.5rem; float:left; display:block; width:100%; clear:both;  "> <b>'.strtoupper($nombre_grupo).' </b> 
...
function genera_barcode_label_minifig($id_minifig,$user_id){
	...
	<div style="width:'.$width.';" class="center" id="lbl_'.$id_minifig.'" >
		<div class="barcode_holder" style="border:0px solid #ccc; margin-bottom:-25px;">
			
			<img src="'.$logo_lbl.'" class="logo_lbl" style="height:25px;">

			<span style="font-size:1rem; display:block; margin-top:10px;" id="n_set_barcode" >'.substr(strtoupper($nombre_es),0,25).'</span>
	
        <span style="display:block; margin-top:-10px;" class="barcode_set_thin_b" id="barcode_set_thin"> 
			 '.$codigob.'
		</span> 
	
		<span style="font-size: 0.6rem; display:block; margin-top:-15px;">'.strtoupper($GLOBALS['sitio_web']).' | <b>'.substr(strtoupper($nombre_serie),0,15).'</b> 																

				
		</div>
	
		<span style="font-size:0.6rem; display:block; margin-top:20px;">'.$fecha_imp.'</span>
...
function get_cards_minifigure_s($serie,$view){
							...
							if($desc_serie==0){
								...
								if($estado_cup == 1){
									...
									$btn_quitar_cupon = '
										...
										<button class="btn btn-outline-primary  btn-sm" value="'.$id_uso_cupon.'" style="margin-top:10px;font-size:0.7rem" onclick="elimina_cupon_uso(\''.$id_uso_cupon.'\');" > <i class="fa-solid fa-eraser"></i> Quitar Cupón </button>
										'; 
	...
	';
									 ...
									 $lbl_cupon_act = '
			<label class="col-sm-8 text-success">Cupón: '.strtoupper($cupon).' <span class="text-danger">(-'.$desc_cup.'%)</span> <br> 
			'.$btn_quitar_cupon.'
			</label>
			<label class="col-sm-4 text-danger">$ '.$mont_desc.' '.strtoupper($moneda_serie).'</label> 
	'; 	                    
				  ...
				  <div class="card-body" style="padding-bottom: 10px;">
					<h4 class="card-title border-bottom"> <span class="text-success">PAGO ÚNICO</span> </h4>
						...
						<div class="row">
									...
									<input type="text" class="col-md-4 form-control border" id="cupon_serie" value="" placeholder="Introduce Clave" >
